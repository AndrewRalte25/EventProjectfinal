       ...
       <div class="container-fluid ">
                    <form action="/event/{{ $event->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input id="name" class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="name" :value="$event->name" required autofocus />
                        </div>

                        <div class="mt-4">
                            <label for="location" class="block font-medium text-sm text-gray-700">{{ __('Location') }}</label>
                            <input id="location" class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="location" :value="$event->location" required />
                        </div>

                        <div class="mt-4">
                            <label for="openinghours" class="block font-medium text-sm text-gray-700">{{ __('Opening Hours') }}</label>
                            <input id="openinghours" class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="openinghours" :value="$event->opening" required />
                        </div>

                        <div class="mt-4">
                            <label for="contactinformation" class="block font-medium text-sm text-gray-700">{{ __('Contact Information') }}</label>
                            <input id="contactinformation" class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="contactinfo" :value="$event->contactinfo" required />
                        </div>

                        <div class="mt-4">
                            <label for="price" class="block font-medium text-sm text-gray-700">{{ __('Price') }}</label>
                            <input id="price" class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="price" :value="$event->price" required />
                        </div>
                        <div class="mt-4">
